...
class PostController extends Controller
{
    ...
    public function exportExcel($params)
    {
        ...
        $sheet->setCellValue('B3', 'Post Category ID');
        $sheet->setCellValue('C3', 'Title');
        $sheet->setCellValue('D3', 'Content');
        $sheet->setCellValue('E3', 'Thumbnail');
        $sheet->setCellValue('F3', 'Tags');
        $sheet->setCellValue('G3', 'Total Views');
        $sheet->setCellValue('H3', 'Created Time');

        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data Post');
        ...
        foreach($searchModel->getQuerySearch($params)->all() as $data){
            ...
            $sheet->setCellValue('B' . $row, $data->post_category_id);
            $sheet->setCellValue('C' . $row, $data->title);
            $sheet->setCellValue('D' . $row, $data->content);
            $sheet->setCellValue('E' . $row, $data->thumbnail);
            $sheet->setCellValue('F' . $row, $data->tags);
            $sheet->setCellValue('G' . $row, $data->total_views);
            $sheet->setCellValue('H' . $row, $data->created_time);
