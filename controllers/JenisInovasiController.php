...
use app\models\JenisInovasiSearch;
...
/**
 * JenisInovasiController implements the CRUD actions for JenisInovasi model.
 */
class JenisInovasiController extends Controller
{
    ...
    /**
     * Lists all JenisInovasi models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new JenisInovasiSearch();
    ...
    /**
     * Displays a single JenisInovasi model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new JenisInovasi model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new JenisInovasi();
    ...
    /**
     * Updates an existing JenisInovasi model.
    ...
    /**
     * Deletes an existing JenisInovasi model.
    ...
    /**
     * Finds the JenisInovasi model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return JenisInovasi the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = JenisInovasi::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function exportExcel($params)
    {
        ...
        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data JenisInovasi');
